...
export const BASE_CSS = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .lv .row { display: grid; grid-template-columns: minmax(6rem, 8rem) 1fr; gap: 6px 20px; padding: 9px 0; border-bottom: 1px solid var(--rule); align-items: baseline; }
  .lv .row > dd { color: var(--ink-2); overflow-wrap: anywhere; }
  .lv .row > dd.mono { font-size: var(--t-data); color: var(--ink); }
  ...
  table.data td.num { font-variant-numeric: tabular-nums; text-align: right; color: var(--ink); font-weight: 600; }
  table.data td.mono, table.data td .mono { font-family: var(--mono); font-size: var(--t-micro); color: var(--graphite); letter-spacing: 0.01em; }
...
export const FLOOR_CSS = `
  ...
  .strip { display: flex; flex-wrap: wrap; align-items: stretch; border-bottom: 1px solid var(--rule); background: var(--plate); }
  ...
  .reg-row { display: grid; grid-template-columns: auto minmax(12rem, 17rem) 1fr auto; gap: 14px clamp(16px, 3vw, 32px); align-items: center; padding: 16px 0; border-bottom: 1px solid var(--rule); }
  ...
  .flow { font-family: var(--mono); font-size: var(--t-micro); color: var(--graphite); }
